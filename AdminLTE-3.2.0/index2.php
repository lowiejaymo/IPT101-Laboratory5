...
if (
        ...
        <div class="sidebar">
          ...
          <div class="image">
              <a href="pages/examples/profile.php">
                <img class="rounded-image" src="pages/profile-picture/<?php echo $_SESSION['profile_picture']; ?>"
                  alt="User profile picture">
              </a>
            </div>
            <div class="info">
            <div class="info"> <a href="pages/examples/profile.php" class="d-block">
  ...
  header("Location: ../AdminLTE-3.2.0/pages/examples/login-v2.php");
  exit();
}
?>