    ...
    <div class="wrapper">
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <a href="../pages/indexes/logout.php" class="btn btn-danger">Logout</a>
        </div>
        </ul>
      </nav>
      <!-- /.navbar -->
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
          ...
          <div class="image">
            ...
            <div class="info">
             <div class="info"> <a href="examples/profile.php" class="d-block">
                  ...
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      <button type="button" class="btn btn-tool" data-card-widget="card-refresh"
                        data-source="widgets.php" data-source-selector="#card-refresh-content">
              ...
              <div class="col-md-3">
                <div class="card card-success">
                  <div class="card-header">
                    ...
                    <div class="card-tools">
                      <button type="button" class="btn btn-tool" data-card-widget="card-refresh"
                        data-source="widgets.php" data-source-selector="#card-refresh-content" data-load-on-init="false">
                        <i class="fas fa-sync-alt"></i>
                      </button>
