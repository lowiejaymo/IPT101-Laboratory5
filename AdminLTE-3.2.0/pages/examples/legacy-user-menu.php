    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
          <img src="../profile-picture/<?php echo $_SESSION['profile_picture']; ?>" class="user-image img-circle elevation-2" alt="User Image">
          <span class="d-none d-md-inline">Alexander Pierce</span>
        </a>
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <!-- User image -->
          <li class="user-header bg-primary">
            <img src="../profile-picture/<?php echo $_SESSION['profile_picture']; ?>" class="img-circle elevation-2" alt="User Image">
